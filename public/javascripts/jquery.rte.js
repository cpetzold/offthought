...
(function($) {
    ...
    return this.each( function() {
        ...
        function toolbar() {
            var tb = $("<ul class='rte-toolbar' id='toolbar-"+ element_id +"'>\
                    <li><a href='#' class='bold'>b</a></li>\
                    <li><a href='#' class='italic'>i</a></li>\
                    <li><a href='#' class='unorderedlist'>list</a></li>\
                    <li><a href='#' class='link'>link</a></li>\
                    <li><a href='#' class='image'>image</a></li>\
                    <li><a href='#' class='disable'>&times;</a></li>\
                </ul>");
